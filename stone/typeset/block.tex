...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\SubFigLegend}[1]{\vspace{-\medskipamount}\centering\sffamily\footnotesize{#1}}
...
\newenvironment{SubFigureBlock}{}{\vspace{-\medskipamount}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% since worked with \centering for the legend
\newcommand{\GydmTabLegend}[1]{\legend{#1}\vspace{\medskipamount}}
