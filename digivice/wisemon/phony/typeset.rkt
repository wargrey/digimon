...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define make-typesetting-rules : (-> Info-Ref Wisemon-Rules)
  (lambda [info-ref]
    (for/list ([typesetting (in-list (find-digimon-typesettings info-ref))])
      ...
      (list (assert (tex-document-destination TEXNAME.scrbl #true #:extension (tex-document-extension renderer #:fallback tex-fallback-renderer)) path?)
            (filter file-exists? (if (not raw-tex?) (racket-smart-dependencies TEXNAME.scrbl) (tex-smart-dependencies TEXNAME.scrbl)))
            (λ [[TEXNAME.ext : Path]]
...
(define make~typeset : Make-Phony
  (lambda [digimon info-ref]
    ...
    (wisemon-make (make-typesetting-rules info-ref))))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(wisemon-register-phony 'typeset make~typeset "generate PDFs via LaTex.")
